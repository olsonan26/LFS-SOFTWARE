...
export const PROFILE_REPORT_SKILL_VERSION = "lfs-person-profile-v1.0";
...
- Never infer guilt, innocence, truthfulness, dangerousness, violence, criminal propensity, future offending, or motive from the role or from Lettrology.
...
- Never turn a shadow trait into an allegation that a specific act occurred.
...
SOURCE RULES:
- Use ONLY the checked elevated and shadow traits supplied in the request plus the meaning of the six perspective labels above.
...
2. Executive Summary: 2–4 developed paragraphs identifying the clearest recurring themes and the main strength/shadow tensions.
...
5. Analyst Summary: 5–8 concise, directly grounded takeaways. No scores or diagnostic labels.
6. Interpretive Note: state clearly that the report synthesizes analyst-selected Lettrology traits and is not a clinical psychological assessment, truthfulness determination, evidence of guilt, or prediction of criminal behavior.
